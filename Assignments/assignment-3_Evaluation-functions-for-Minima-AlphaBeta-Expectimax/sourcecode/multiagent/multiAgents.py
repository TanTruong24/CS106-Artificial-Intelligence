...
class MinimaxAgent(MultiAgentSearchAgent):
    ...
    def getAction(self, gameState):
        ...
        def maxValue(state, agentIdx, depth):
            ...
            bestScore, bestActions = -(float("inf")), None
...
def betterEvaluationFunction(currentGameState):
    ...
    a1, a2, a3, a4, a5, a6, a7 = 1, -2, -5, 1, -4, -10, -3
    ans = currentGameState.getScore() + a2*md_closest_food + a3*(1.0/dist_nearest_activeghost) + \
