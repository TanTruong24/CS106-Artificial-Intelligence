...
class Game:
    ...
    def auto_move(self):
        #strategy = get_move(self.level.structure[:-1], self.level.position_player, self.index_level, 'dfs')
        #strategy = get_move(self.level.structure[:-1], self.level.position_player, self.index_level, 'bfs')
        strategy = get_move(
            self.level.structure[:-1], self.level.position_player, self.index_level, 'ucs')
